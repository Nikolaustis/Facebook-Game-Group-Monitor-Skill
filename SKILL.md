---
name: fb-group-monitor-v6.0.0
description: 用于 Facebook 游戏群组两阶段监测的严格技能。V6.0.0 默认通过 Windows 任务计划程序执行第二轮，支持重启后登录自动续跑、逐候选完整 checkpoint、运行期电源保护、严格完成校验后关机和任务自删除；同时保留 V5.8.0 及此前全部规则。
---

# Facebook Group Monitor V6.0.0





## V6.0.0 任务计划程序、完整断点与电源规则
