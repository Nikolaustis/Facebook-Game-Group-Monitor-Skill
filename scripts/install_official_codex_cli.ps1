...
Write-Host '  3. Do NOT create a global CODEX_CLI_PATH environment variable.'
Write-Host '  4. Run: npm run semantic:verify-codex'
Write-Host '  5. Optional: configure codex_exec.command locally or use FB_MONITOR_CODEX_CLI_PATH.'
